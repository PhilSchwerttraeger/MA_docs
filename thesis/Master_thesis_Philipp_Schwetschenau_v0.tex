...
\noindent Class diagrams can have different levels of detail.
...
With \textit{type} and \textit{multiplicity} a element can be constrained regarding the kind and number of its values.

The format for its bounds in BNF\footnote{Backus-Naur form} is defined as following:
