...
As seen in figure \ref{fig:ERD_as_UML} the diagram differs from the diagram in figure \ref{fig:ERD_minimal_example} in its appearance in almost all aspects, but still they are easy to read and to translate into each other.
