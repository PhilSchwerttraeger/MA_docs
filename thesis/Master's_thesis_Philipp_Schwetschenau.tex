...
It appears that the modular approach we are going to use to solve the problems above can generate quite large models.
Also it may happen that a user wants to model certain model aspects less prominent than others to keep the focus on important parts.
So for reducing the visual complexity whenever needed, and to let the user have a choice how prominent graphical aspects should be depicted, there is need for a concept for depicting information in a compact way.
This is our secondary design goal.
