...
Also the notation used by \citet*{Amthor18} to graphically model the process of Entity-Labeling, which was slightly inspired by the graphical RBAC notation by \cite{Sandhu96}, will be described.
...
For this model components of an informally specified policy have to be identified and formalized by classifying them into six semantic categories:
