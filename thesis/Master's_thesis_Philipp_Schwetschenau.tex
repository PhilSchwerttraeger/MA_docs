...
In this chapter is about the implementation of the EL editor.

In section \ref{implementation_base}
In section \ref{implementation_structure}
In section \ref{implementation_sections}
