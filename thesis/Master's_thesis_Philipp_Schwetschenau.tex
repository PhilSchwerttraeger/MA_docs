...
Additionally a figure now needs a legend to show the assignment of colors to the corresponding EL categories.
With $m=1$ we have six different categories and therefore colors.
