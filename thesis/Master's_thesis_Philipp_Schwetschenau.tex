...
Furthermore it presents the basic concepts of the graphical notation models UML and ER as well as concepts and patterns for designing and evaluating graphical notations and software graphical user interfaces.
...
After isolating these problems matching concepts are proposed to solve them and to construct a new graphical specification language regarding design goals.
...
Chapter 7 discusses current limits and open issues of the language and the editor to give a short outlook for further improvement and possible extensions.
...
While section \ref{editor_extensions} of chapter \ref{editor} suggested optional advanced features for the editor, this section discusses aspects of future development.
...
Asides from the required XML section the feature of creating and modifying custom categories also requires a dynamic widget that allows adding, removing and modifying of categories. 
...
This view would highly benefit from large screens.
...
Extending concepts were derived from established graphical notations and are designed with the help of gestalt laws to enhance their visual quality and handling.
