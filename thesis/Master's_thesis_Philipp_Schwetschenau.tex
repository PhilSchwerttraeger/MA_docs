...
The expression can be $2^X$ when directly used at a set $X$, 2\textsuperscript{$\wedge$} otherwise, e.g.\ at an \textit{operator element} (see section \ref{operator_elements}) that involves multiple elements.
