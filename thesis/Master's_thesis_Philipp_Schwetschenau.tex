...
%e.g. abacalpha
With regard to \cite{Zeckzer14} the amount of different elements being held in our visual buffer is limited (section \ref{human_optical_perception}).
Therefore the number of additional elements the language can be reasonably extended with is limited as well.
Currently having five node types and 2 edge types this limit is almost exhausted.
This is the reason the language is currently designed the way it is.
