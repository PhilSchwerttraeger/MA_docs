...
%future
After heavily improving the language after its evaluation, it still has some open issues and limitations.
Currently it is limited to the mathematical concepts of sets, set operations, mappings, relations and constraints.
From looking at definitions of established security models these concepts cover many models and its elements, but depicting any other or new concepts (that are not possible to compose with the existing elements) will require an extension or adaption of the language.
