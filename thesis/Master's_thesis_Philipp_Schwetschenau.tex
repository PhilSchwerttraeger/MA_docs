...
Relations that exclusively refer to identical sets such as $\mathit{RH} \subseteq R \times R$ constitute an exception to that rule and can omit roman numerals, because a order is not necessary to convert it to its mathematical form (e.g.\ figure \ref{fig:HIX2}).
