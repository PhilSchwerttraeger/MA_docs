...
In addition to the development of the graphical specification language a GUI-based editor should be developed as a prototype tool to make use of the language.
