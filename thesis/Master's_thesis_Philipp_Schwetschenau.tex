...
\noindent
We introduce several options to vary the visual complexity:
- annotation instead of pre-placed relation for single-use power-set
- sets formula instead of combination of relations
