...
With this said we want to start off with the graphical notation \cite{Amthor18} uses to depict the EL aspect and try to expose and analyze its two major problems: ambiguously depicted relationships and categorization.
...
When handling three or more arguments the order of operations (may be indicated with brackets) has to be considered and depicted as well.
