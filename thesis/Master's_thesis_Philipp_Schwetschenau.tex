...
In section \ref{implementation_sections} more details on two prominent GUI sections are given.
And in the last section of this chapter the concept for importing and exporting data from and to an XML-based file format for persistent storage is explained in section \ref{implementation_importexport}.
...
This section covers two essential GUI sections of the editor: The \textit{Graphics Scene} in section \ref{implementation_graphicsscene} and the \textit{Side Section} in section \ref{implementation_side_section}.
