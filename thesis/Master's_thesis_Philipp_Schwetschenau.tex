...
Finally we construct the individual definition for each element by visiting all arrows/lines and connected elements: We obtain all element definitions (see definition \ref{definition:RBAC}).
