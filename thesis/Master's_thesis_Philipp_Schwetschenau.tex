...
In section \ref{gsl_elements} all graphical elements developed are then depicted visually and described regarding their function and usage.
...
Set's internal composition can be depicted as textual formula inside its shape but can also be graphically modeled outside of it with a combination of other elements.
Similar to the first method this gives the modeler the option to adjust the level of detail.
Also the individual benefits of the single-use compact form (here: formula) versus the multi-referenceable entity (here: graphical depiction with elements) from above is similar here.
\end{description}
...
\noindent
Alternatively they can be depicted completely graphically with the help of other elements.
Figure \ref{fig:subsets_alternative} shows such variant of figure \ref{fig:subsets}.
It is semantically equivalent.

\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.4]{../figures/chapter3/subsets_alternative.png}
	\caption{Alternative depiction variants}
...
Note that unlike the subset depiction above a formula can not depict the category membership of participating sets and is therefore \textit{not} semantically equivalent to its graphical counterpart.
...
The graphical depiction is favored 
