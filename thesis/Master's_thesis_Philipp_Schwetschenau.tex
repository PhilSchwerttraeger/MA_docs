...
Set's internal composition can be depicted as textual formula inside its shape but can also be graphically modeled with a combination of other elements.
Similar to the first method this gives the modeler the choice how detailed a set should be depicted.
Also the individual benefits of the single-use compact form versus multi-referenceable entity from above is very similar here.
\end{description}
