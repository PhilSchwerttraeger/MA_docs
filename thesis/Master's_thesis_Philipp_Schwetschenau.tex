...
The two major problems of the graphical EL notation used by \cite{Amthor18}, which makes it inconsistent and ambiguous, are the ambiguously depicted relationships between elements and the ambiguous method of classifying elements.

\begin{mdframed}[style=mystyle,frametitle=Web addresses in text]
Note: Henceforth all possible connections between elements like mappings, relations, constraints, etc.~are referred to as \textit{relationships}.
\end{mdframed}
...
\vspace{4mm}
\noindent
\textbf{Problem 3: Ambiguously depicted categorization}
\vspace{1mm}
