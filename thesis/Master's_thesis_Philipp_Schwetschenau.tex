...
\vfill \parbox{\detailwidth}{
	\makebox[\detaildescriptionwidth][r]{Advisor:~~} Prof. Dr.-Ing. habil. Winfried E. Kühnhauser \\
	\makebox[\detaildescriptionwidth][r]{Advisor:~~} Dipl.-Inf. Peter Amthor \\
	\vspace{2ex} \\
	\makebox[\detaildescriptionwidth][r]{Program:~~} Computer Science (Master) 2010\\  
	\makebox[\detaildescriptionwidth][r]{Matriculation number.:~~} 46756  
	\vspace{2ex} \\
