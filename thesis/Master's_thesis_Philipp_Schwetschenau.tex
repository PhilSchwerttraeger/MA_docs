...
\vspace{8mm}
\noindent
\textbf{Problem 2: Multiple arguments}
\vspace{1mm}
...
Therefore we have to depict $E$ two times at once (in $LS_1$ and $C$), which makes the figure redundant and thus confusing.\\
...
\vspace{2mm}
\noindent
\textbf{Solution to problem 2: Multiple arguments}
\vspace{1mm}
...
To indicate and determine the order of arguments \textit{roman numerals} can be used as annotations.
