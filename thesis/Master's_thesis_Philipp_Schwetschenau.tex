...
\vfill {\large
	Masterarbeit\\ \vspace{2ex}
	\LARGE \textbf{A Graphical Specification Language \\
	for Depicting Security Models \\
	in Context of Entity-Labeling} \\ \vspace{2.5ex}
	\normalsize Vorgelegt von: \\
	\Large Philipp Schwetschenau \\ \vspace{3ex} 
}
\vfill \parbox{\detailwidth}{
	\makebox[\detaildescriptionwidth][r]{Betreuer:~~} Prof. Dr.-Ing. habil. Winfried E. Kühnhauser \\
	\makebox[\detaildescriptionwidth][r]{Betreuer:~~} Dipl.-Inf. Peter Amthor \\
	\vspace{2ex} \\
	\makebox[\detaildescriptionwidth][r]{Studiengang:~~} Informatik (Master) 2010\\  
	\makebox[\detaildescriptionwidth][r]{Matrikel-Nr.:~~} 46756  
	\vspace{2ex} \\
	\makebox[\detaildescriptionwidth][r]{Eingereicht:~~} Ilmenau, 29. November 2018
}
\vspace*{\fill}
\end{center}
\end{titlepage}
...
The role hierarchy is defined as partial order $\mathit{RH} \subseteq R \times R$.% on $R$. %(also written as $\geq$).
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-7.5cm]{../figures/chapter3/legend.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-4cm]{../figures/chapter3/relationships.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth-7cm]{../figures/chapter3/relationship_operation_2args.png}
...
\begin{figure}[!htb]
	\centering
	\includegraphics[width=\linewidth-5cm]{../figures/chapter3/relationship_operation_3args.png}
...
%\begin{figure}[!htb]
%	\centering
%	\includegraphics[width=\linewidth-7cm]{../figures/chapter3/operation_order.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-7.5cm]{../figures/chapter3/relationship_annotation.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.38]{../figures/chapter3/subsets_alternative.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.15]{../figures/chapter3/subsets_formula.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.27]{../figures/chapter3/subsets_externally.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-4cm]{../figures/chapter3/HIX2.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.13]{../figures/chapter6/RBAC96_v5_variant_stage1.png}
...
%\begin{figure}[htb]
%	\centering
%	\includegraphics[scale=0.13]{../figures/chapter6/RBAC96_v5_variant_stage2.png}
%	\caption{}
%	\label{fig:RBAC96_v5_variant_stage2}
%\end{figure}
%
%\noindent
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-2.5cm]{../figures/chapter6/RBAC96_v5_variant_stage3.png}
...
%\begin{figure}[htb]
%	\centering
%	\includegraphics[scale=0.13]{../figures/chapter6/RBAC96_v5_variant_stage4.png}
%	\caption{}
%	\label{fig:RBAC96_v5_variant_stage4}
%\end{figure}
%\noindent
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-0.5cm]{../figures/chapter6/RBAC96_v5_variant.png}
...
\begin{figure}[htb]
	\centering
	\includegraphics[scale=0.13]{../figures/chapter6/RBAC96_v5.png}
...
%\begin{figure}[htb]
%	\centering
%	\includegraphics[width=\linewidth-1cm]{../figures/chapter6/RBAC96_Amthor.png}
%	\caption{Visual summary of RBAC96 \cite{Amthor18} uses}
%	\label{fig:RBAC96_Amthor}
%\end{figure}
%
%\noindent
%When comparing the resulting model (figure \ref{fig:RBAC96_v5}) to the initial \textit{visual summary} \cite{Amthor18} used and which was improved in this work the lack of consistency becomes clear.
%Figure \ref{fig:RBAC96_Amthor} shows the visual summary \cite{Amthor18} depicts to represent RBAC in context of EL.
%Note that there are no constraints in this model, but a constraint example is depicted in a symbolic way to show how they would look like.
%In comparison to figure \ref{fig:RBAC96_v5} this depiction clearly lacks all problems identified and improved in section 
%\ref{gsl_concept}.
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-1cm]{../figures/chapter6/CoreABAC.png}
	\caption{CoreABAC}
	\label{fig:CoreABAC}
\end{figure}
...
\begin{figure}[htb]
	\centering
	\includegraphics[width=\linewidth-1cm]{../figures/chapter6/refinedElements.png}
...
\begin{figure}[bht]
	\centering
	\includegraphics[width=\linewidth]{../figures/chapter6/RBACmodeled2.png}
...
\section{Language}
\label{future_GSL}
The language is build up on four basic mathematical concepts: sets, mappings, relations, constraints and set operators.
This limits drawing and composing model elements to exactly these elements.
...
One solution would be extend the language with the missing concepts, in this case by adding a new element:
...
The necessary modification to integrate this additional concept is rather large.
Due to the increased visual complexity the resulting model (see figure \ref{fig:ABACalpha}, also compare to figure A.1 in \cite{Amthor18}) is confusing to understand; at this point a (isomorphic) graphical modeling is not very advantageous anymore.

\begin{figure}[bht]
	\centering
	\includegraphics[width=\linewidth]{../figures/chapter7/ABACalpha3.png}
...
Not only extending with additional elements, also extending with concepts like another level of categorization is not recommended, due to already handling two categorization methods, specifying element types through their geometrical shapes and EL categories through colors.
Instead additional diagram type, that focus on other aspects than EL, could be introduced similar to diagram types in UML having one specific aspect each (section \ref{UML}).

Beside extending it there is room for improving the language itself.
One is the use of roman numerals for indicating the order of operands participating in an operation that needs a determined operand order (e.g.\ $\mathit{UA}$ in figure \ref{fig:RBAC96_v5_variant_stage3}).
Especially the usage in combination with edge annotations like $R^2$ can be visually conflicting.
There may be a more elegant solution for that.

% less reasonable models: HRU


\section{Editor}
\label{future_editor}
The feature set of the editor is currently limited to its basic functions.
While section \ref{editor_extensions} of chapter \ref{editor} suggested optional advanced features for the editor, this section should discuss aspects of future development.
The next steps are to add features as well as further improve stability.

One important aspect for actual usage and integration with other software is to improve the modules for importing and exporting models.
Currently the XML-based file format does not have a general model section that would support the import and export of any categories other than the standard EL categories (for $m=1$), which is necessary for the additional feature of creating and modifying custom categories and category colors.
For the latter a dynamic widget has to be provided that allows adding, removing and modifying of categories. 
For each category its name, XML tag and color has to be configured (tag and color could be generated automatically).
An additional button for retrieving the standard EL preset can help configuring the  correct ELM format (Entity Labeling Markup) for compatibility with model analysis and verification tools after export.

Regarding the graphical elements, the depiction of texts inside element shapes could be further improved, e.g.\ with \textit{dynamic centering and resizing} depending on actual properties being set, not set or having very large values.
Furthermore formulas could be visually enhanced by integrating a dedicated Latex module for handling the correct depiction of mathematical terms.
...
To illustrate such mathematically specified models \cite{Amthor18} uses a visual summary.
...
%how
For this the visual summary was analyzed and five major problems were isolated regarding its ambiguousness.
After that matching solutions were developed in form of concepts that extend the notation.
Extending concepts derived from established graphical notations and are designed with the help of gestalt laws to enhance their visual quality and handling.
...
%results
The resulting language is a consistent stand-alone specification method, that is isomorphic to its mathematical counterpart.
...
The amount of language extensions is limited to maintain a reasonable usability.
